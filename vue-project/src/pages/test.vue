              ...
              <template #summary>
                <a-table-summary-row>
                  <a-table-summary-cell>
                    <span>
                      <AreaChartOutlined @click="echartsQualityVisible=true"/>
                      Total
                    </span>
                    <a-modal
                      v-model:open="echartsQualityVisible"
                      title="品质数据分析"
                      :footer="null"
                    >
                        <div class="card-container">
                            <a-tabs v-model:activeKey="activeKey1" type="card">  
                                <a-tab-pane tab="柱状图" key="1"><HistogramComponent typeClass="Quality"/></a-tab-pane>  
                                <a-tab-pane tab="饼图" key="2"><PieChartComponent typeClass="Quality"/></a-tab-pane>
                            </a-tabs>
                        </div>
                    </a-modal>
                  </a-table-summary-cell>
              ...
              <template #summary>
                <a-table-summary-row>
                  <a-table-summary-cell :col-span="3">
                    <span>
                      <AreaChartOutlined @click="echartsHeroVisible=true"/>
                      Total
                    </span>
                    <a-modal
                      v-model:open="echartsHeroVisible"
                      title="武将数据分析"
                      :footer="null"
                    >
                        <div class="card-container">
                            <a-tabs v-model:activeKey="activeKey2" type="card">  
                                <a-tab-pane tab="柱状图" key="1"><HistogramComponent typeClass="Hero"/></a-tab-pane>  
                                <a-tab-pane tab="饼图" key="2"><PieChartComponent typeClass="Hero"/></a-tab-pane>
                            </a-tabs>
                        </div>
                    </a-modal>
                  </a-table-summary-cell>
...
import { LoadingOutlined, PoweroffOutlined, AreaChartOutlined } from '@ant-design/icons-vue';
import { h } from 'vue';
import * as XLSX from 'xlsx';
import { toFixed } from 'ant-design-vue/es/input-number/src/utils/MiniDecimal';
import HistogramComponent from '@/components/echarts/HistogramComponent.vue';
...
const planID = ref();
const echartsQualityVisible = ref(false);
const echartsHeroVisible = ref(false);
